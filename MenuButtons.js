...
import FontAwesame from "react-native-vector-icons/FontAwesome";
    ...
    return (
        <View style={styles.container}>
            ...
            <View
                ...
                >
                    <FontAwesame name={item.name} size={23} color={"#efefef"} />   
                </TouchableOpacity>
                <Text style={styles.menuText} key={item.id}>{item.title}</Text>
            </View>
            ) ) }
        </View>
    )
